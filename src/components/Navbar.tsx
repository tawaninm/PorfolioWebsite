  ...
  return (
    <>
      <motion.nav
        ...
        className="fixed top-0 left-0 w-full z-50 backdrop-blur-lg bg-vinyl-dark/60 border-b border-neon-magenta/20"
      >
        {/* Halftone overlay */}
      ...
      {/* Mobile sidebar — rendered outside nav to avoid overflow clipping */}
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            initial={{ opacity: 0 }}
          ...
          >
            ...
            <motion.div
              ...
              className="absolute right-0 top-0 h-full w-72 max-w-[80vw] bg-vinyl-dark border-l border-neon-magenta/30 flex flex-col justify-center items-stretch overflow-hidden px-8"
            >
