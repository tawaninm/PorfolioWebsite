...
export const projects: Project[] = [
  ...
  },
  {
    ...
    thumbnail: "/images/Project/Synchro/Preview and gallery.png",
    heroImage: "/images/Project/Synchro/Preview and gallery.png",
    date: "2025",
    ...
    gallery: [
      ...
      "/images/Project/Synchro/58.png",
      "/images/Project/Synchro/59.png",
      "/images/Project/Synchro/61.png",
      "/images/Project/Synchro/62.png",
      "/images/Project/Synchro/63.png",
      "/images/Project/Synchro/64.png",
      "/images/Project/Synchro/65.png",
      "/images/Project/Synchro/66.png",
      "/images/Project/Synchro/67.png",
      "/images/Project/Synchro/69.png",
      "/images/Project/Synchro/70.png",
      "/images/Project/Synchro/71.png",
      "/images/Project/Synchro/72.png",
      "/images/Project/Synchro/73.png",
      "/images/Project/Synchro/74.png",
      "/images/Project/Synchro/75.png",
      "/images/Project/Synchro/76.png",
      "/images/Project/Synchro/77.png",
      "/images/Project/Synchro/78.png",
      "/images/Project/Synchro/79.png",
      "/images/Project/Synchro/80.png",
      "/images/Project/Synchro/81.png",
    ],
  },
  {
    slug: "drive-kmitl",
