...
export const projects: Project[] = [
  ...
  },
  {
    ...
    date: "2026",
    tags: ["Business Case Competition", "Marketing Strategy", "O2O Experience Design", "Brand CI", "Financial Modeling", "UGC Viral Loop", "Celebrity-Free Strategy", "Team อาโหร่ยจริงๆครับพี่น้อง"],
    techStack: ["Business Case Structuring (SCQ)", "Financial Projections & Break-even Modeling", "Customer Journey Mapping (O2O)", "Brand Identity System (CI)", "Booku POS & Smart e-Queue Architecture", "Figma", "Canva", "Adobe Illustrator"],
    summary: "แผนกลยุทธ์การตลาดธุรกิจและประสบการณ์ O2O ที่พัฒนาขึ้นสำหรับการแข่งขัน NOSE TEA Marketing Business Case Competition 2026 (โครงการ 'Sip to Scale' ชิงเงินรางวัลรวมกว่า 385,000 บาท) โดยทีม 'อาโหร่ยจริงๆครับพี่น้อง' ภายใต้โจทย์ท้าทาย: ออกแบบแคมเปญออนไลน์ 30 วันเพื่อสร้าง Brand Awareness และ Consumer Engagement ที่วัดผลได้จริง ภายใต้งบประมาณ 500,000 บาท โดยไม่ใช้บุคคลที่มีชื่อเสียง (Celebrity-Free)\n\nทีมงานนำเสนอแนวคิด 'Nosey's 45° Green Mustache DIY Studio' พลิกแพลงหลักการดื่มชาชีสที่มุม 45 องศาให้กลายเป็นพิธีกรรมทางศิลปะ (Sip Ritual) ด้วยฝาครอบฉลุลาย Stencil ที่ปั๊ม 'หนวดชีสสีเขียวมัทฉะ' ใต้จมูกเลียนแบบมาสคอต Chibi Nosey เชื่อมโยงระบบ Smart e-Queue และ e-Receipt ของ Booku POS เข้ากับ LINE OA 100% ไร้ขยะกระดาษ ตู้ Photo Booth เซลฟี่ และสถานีตกแต่งเฟรมการ์ด DIY หน้าร้าน คาดการณ์ยอดขาย 15,000 แก้ว รายได้สะสม 1,800,000 บาท คืนทุนในสัปดาห์ที่ 3 (7,576 แก้ว) ให้ผลตอบแทนการลงทุน ROI สูงถึง 260% และปกป้องอัตรากำไรขั้นต้น (GP Margin) หน้าร้านที่ 55%",
    problem: "ตลาดเครื่องดื่มชาพรีเมียมของไทยมูลค่ากว่า 26,000 ล้านบาทตกอยู่ในภาวะ Red Ocean ที่แข่งขันรุนแรง การมีรสชาติที่ดีอย่างเดียวไม่เพียงพอต่อการสร้างความภักดีต่อแบรนด์ (Brand Loyalty) ขณะที่ Organic Reach บนโซเชียลมีเดียลดลงอย่างต่อเนื่องบีบให้ต้นทุนการตลาดสูงขึ้น นอกจากนี้ Nose Tea ยังเผชิญความท้าทายเรื่องคอขวดเวลารอคิวหน้าร้านนาน (Queue Congestion) และความกังวลด้านแคลอรี่ของผู้บริโภค (Calorie Guilt) โดยโจทย์การแข่งขันบังคับห้ามใช้ดาราหรือ Celebrity ทุกรูปแบบ และต้องคุมงบประมาณไม่เกิน 500,000 บาท",
    process: "วิเคราะห์คู่แข่งแยกตามโอกาสการบริโภค (CHAGEE, BEARHOUSE, GAGA, Karun) และทำ SWOT Audit เพื่อหา Strategic Gap -> พัฒนา Persona 'Gen Z Campus' (อายุ 17-24 ปี) ที่โหยหา 1-of-1 Personalization และ Tangible Nostalgia -> ออกแบบแกนสร้างสรรค์ 'Nosey's 45° Green Mustache DIY Studio' แปลงมุมจิบ 45° ให้เป็นกิมมิกหนวดชีสเขียว -> วางสถาปัตยกรรมระบบ O2O ผสาน Booku POS, Smart e-Queue, ตู้ Photo Kiosk, และ DIY Counter แยกสัดส่วนเพื่อลดคอขวด -> คำนวณโมเดลการเงิน ต้นทุนวัตถุดิบ (COGS 45%), จุดคุ้มทุน (7,576 แก้ว), และจัดสรรงบ 500,000 บาทอย่างมีประสิทธิภาพ",
    result: "The Solution: แผนกลยุทธ์ O2O ฉบับสมบูรณ์ 20 สไลด์หลัก พร้อมภาคผนวกการบริหารความเสี่ยงและแนวทางการตอบคำถามกรรมการ (Q&A Defense Guide) ที่บูรณาการระหว่าง Brand Theatre, Physical Gamification, และระบบ CRM ไร้กระดาษ\nImpact: โมเดลการเงินพิสูจน์ความเป็นไปได้เชิงพาณิชย์ คืนทุนได้ในสัปดาห์ที่ 3 (Break-even 7,576 แก้ว), คาดการณ์รายได้ 1,800,000 บาท (ROI 260%), เพิ่มฐานสมาชิก LINE OA +15,000 ราย, รักษา Store GP Margin 55% และสร้างปรากฏการณ์บอกต่อแบบ Organic UGC ผ่านชาเลนจ์หนวดชีส 45 องศาโดยไม่ต้องพึ่งพาดารา",
    highlights: [
      { label: "Team Name", value: "อาโหร่ยจริงๆครับ", detail: "Nose Tea Sip to Scale Competition 2026" },
      { label: "Projected ROI", value: "260%", detail: "Break-even at 7,576 cups (Week 3)" },
      { label: "Budget Constraint", value: "฿500,000", detail: "Celebrity-free 30-day O2O viral strategy" },
      { label: "Target Revenue", value: "฿1,800,000", detail: "15,000 cups + 15k new LINE OA members" },
    ],
    sections: [
      {
        badge: "01 STRATEGIC SCQ & RED OCEAN AUDIT",
        title: "Red Ocean Tea Market & The Queue Congestion Dilemma",
        subtitle: "การวิเคราะห์โครงสร้าง SCQ และการเปลี่ยนวิกฤตคิวหน้าร้านให้กลายเป็นโรงละครแบรนด์ (Brand Theatre)",
        content: "ตลาดชาชงพรีเมียมของไทยมูลค่ากว่า 26,000 ล้านบาทกำลังเติบโตอย่างดุเดือดท่ามกลางคู่แข่งยักษ์ใหญ่ ทั้งแบรนด์พรีเมียมระดับโลก (CHAGEE, HEYTEA) และแบรนด์ขวัญใจมหาชน (BEARHOUSE, GAGA, Karun)\n\nแม้ Nose Tea จะโดดเด่นด้วยจุดขายชาชีสคุณภาพสูง 'ทุกแก้วคือแก้วแรก' แต่กลับพบอุปสรรคสำคัญ 2 ประการ: คอขวดการรอคิวหน้าร้าน (Queue Congestion) อันเกิดจากความพิถีพิถันในการชง และการลดลงของ Organic Reach บนโซเชียลมีเดีย ทีมงานจึงตั้งคำถามเชิงกลยุทธ์ว่า: เราจะเปลี่ยนการรอคิวที่น่าเบื่อให้กลายเป็น 'Brand Theatre' ที่ลูกค้าสนุกจนลืมเวลาได้อย่างไร?",
        image: "/images/Project/NoseTea/2.png",
        imageCaption: "สไลด์ Strategic SCQ Executive Summary: การจัดโครงสร้างปัญหา โอกาส และผลลัพธ์ทางการเงินของโครงการ",
        type: "cards",
        items: [
          {
            tag: "SITUATION",
            title: "฿26B Premium Tea Market",
            subtitle: "ตลาดชาชงพรีเมียมมูลค่า 26,000 ล้านบาท",
            description: "ตลาดขยายตัวต่อเนื่องแต่ความภักดีต่อแบรนด์ลดลง ผู้บริโภคพร้อมเปลี่ยนใจตามกระแสเมนูใหม่และการมองหาความคุ้มค่าเชิงประสบการณ์",
          },
          {
            tag: "COMPLICATION",
            title: "Queue Bottleneck & Ad Fatigue",
            subtitle: "คอขวดเวลารอคิวและค่าแอดพุ่งสูง",
            description: "การรอคิวนานส่งผลต่อ Walk-away Rate ขณะที่อัลกอริทึมโซเชียลบีบให้พึ่งพา Paid Ads ทำให้ต้นทุนการตลาดพุ่งสูงเกินจำเป็น",
          },
          {
            tag: "QUESTION / SOLUTION",
            title: "Nosey's 45° DIY Studio",
            subtitle: "เปลี่ยนเวลารอคิวเป็น Brand Theatre",
            description: "แคมเปญ O2O 30 วัน งบ 500,000 บาท แบบ Celebrity-Free นำเสนอกิมมิกปั๊มหนวดชีสเขียว 45° ผสานตู้เซลฟี่และสถานี DIY เฟรมการ์ด",
          },
          {
            tag: "STRATEGIC IMPACT",
            title: "฿1.8M Revenue & 260% ROI",
            subtitle: "เป้าหมายรายได้และผลตอบแทนการเงิน",
            description: "เป้ายอดขาย 15,000 แก้ว คืนทุนในสัปดาห์ที่ 3 (7,576 แก้ว) ได้สมาชิก LINE OA ใหม่ +15,000 ราย และรักษา Store GP ปลอดภัยที่ 55%",
          },
        ],
      },
      {
        badge: "02 CONSUMER INSIGHT & BRAND DIFFERENTIATION",
        title: "Gen Z Campus Persona & The 45° Scientific Sip Ritual",
        subtitle: "ถอดรหัสพฤติกรรม Gen Z, การทลายกำแพง Calorie Guilt และการเปลี่ยนมุมยกดื่มเป็นไวรัลแบรนด์",
        content: "กลุ่มเป้าหมายหลักคือ 'Gen Z Campus' (อายุ 17-24 ปี) ผู้มองเครื่องดื่มเป็น Lifestyle Statement และโหยหาประสบการณ์เชิงกายภาพที่จับต้องได้ (Tangible Nostalgia) พร้อมกระแสความนิยมสะสม Photocard Frame Deco และสติกเกอร์ 1-of-1 Personalization\n\nทีมงานนำหลักวิทยาศาสตร์ 'การยกดื่มชาชีสที่มุม 45 องศาเพื่อรสสัมผัสที่ดีที่สุด' มาทำ Consumption Gamification ด้วยฝาครอบฉลุลาย Stencil (โลโก้จมูกเขียว) เมื่อยกดื่ม ผงมัทฉะนิวซีแลนด์จะประทับเป็น 'หนวดชีสสีเขียว' ใต้จมูกเลียนแบบมาสคอต Chibi Nosey ทลายความกังวล Calorie Guilt ด้วยตัวเลือกความหวาน 0-50% และน้ำเชื่อม Stevia",
        image: "/images/Project/NoseTea/7.png",
        imageCaption: "สไลด์ Brand Differentiation: การแปลงหลักวิทยาศาสตร์การจิบชาชีส 45 องศาให้กลายเป็นกิมมิกหนวดชีสเขียว",
        type: "grid",
        items: [
          {
            tag: "TARGET PERSONA",
            title: "Gen Z Campus (Ages 17-24)",
            subtitle: "กลุ่มนักเรียน-นักศึกษาผู้รักไลฟ์สไตล์",
            description: "ค้นพบร้านใหม่ผ่าน TikTok/Reels ชอบสะสมพวงกุญแจและเฟรมการ์ด ถ่ายรูปตู้ Photo Booth บ่งบอกอัตลักษณ์หนึ่งเดียวของตนเอง",
          },
          {
            tag: "CALORIE GUILT",
            title: "Emotional Reward vs Health",
            subtitle: "ความสุขเยียวยาชีวิตหลังเลิกเรียน",
            description: "ทลายความกังวลสุขภาพด้วยตัวเลือกระดับความหวาน 0%, 25%, 50% และน้ำเชื่อมธรรมชาติ Stevia ตอบรับเทรนด์รักสุขภาพโดยไม่เสียรสชาติ",
          },
          {
            tag: "SIP RITUAL",
            title: "45° Stencil Lid Gamification",
            subtitle: "การยกดื่มที่มุมองศาที่อร่อยที่สุด",
            description: "ฝาครอบฉลุลายฉลุ Stencil รูปจมูกโรยผงมัทฉะพรีเมียม เมื่อยกดื่ม 45° วิปชีสจะปั๊มติดเหนือริมฝีปากเป็นหนวดชีสเขียวกวนๆ ชวนถ่ายคลิป",
          },
          {
            tag: "1-OF-1 VALUE",
            title: "Tangible Nostalgia & Deco",
            subtitle: "เอกลักษณ์เฉพาะตัวหนึ่งเดียว",
            description: "ตอบโจทย์เทรนด์ตกแต่ง Photocard Frame แฮนด์เมด ให้ลูกค้านำรูปเซลฟี่หนวดชีสของตนเองมาประดับและแชร์ลงโซเชียลอย่างภาคภูมิใจ",
          },
        ],
      },
      {
        badge: "03 O2O OPERATIONS & CUSTOMER JOURNEY",
        title: "3S Journey (Sip, Style, Share) & Zero-Waste Smart e-Queue",
        subtitle: "สถาปัตยกรรมเชื่อมต่อระบบหน้าร้าน Booku POS, ตู้ถ่ายรูปเซลฟี่, และเวิร์กชอป DIY โดยไร้ขยะกระดาษ",
        content: "เพื่อป้องกันคอขวดหน้าร้านและสร้างความประทับใจระดับพรีเมียม แคมเปญได้วางผัง Customer Flow ผ่านบันได 3S Milestone Loop:\n\n1. SIP (แก้วแรก): สั่งผ่านตู้ Booku POS รับ e-Queue & e-Receipt ส่งตรงเข้า LINE OA ไร้ขยะกระดาษ ถ่ายเซลฟี่หน้าเปื้อนหนวดชีสที่ตู้ Photo Kiosk แล้วรับฟรี 'Nosey DIY Frame Starter Kit'\n2. STYLE (แก้วสอง): กลับมาซื้อซ้ำหรือพาเพื่อนมาร่วมสนุก ได้สิทธิ์ใช้ตรายาง Chibi และสติกเกอร์ 3D โดมปุ่มที่เคาน์เตอร์ DIY ขนาด 1.5-2 ตร.ม.\n3. SHARE (แชร์โซเชียล): ถ่ายรูปอวดหน้าหนวดชีสคู่กับเฟรมการ์ดลง TikTok/Reels ติดแท็กร้าน รับ 'Chibi Nosey Silicon Charm' คล้องเป็นพวงกุญแจครบชุด หากหน้าร้านแออัด พนักงานจะแจกชุด Take-Home DIY Kit ทันที",
        image: "/images/Project/NoseTea/14.png",
        imageCaption: "สไลด์ Customer Flow Phase 2: เส้นทาง 3S (Sip, Style, Share) และการบริหารพื้นที่ DIY Counter หน้าร้าน",
        type: "cards",
        items: [
          {
            tag: "1. SIP",
            title: "e-Queue & Frame Starter Kit",
            subtitle: "จิบแก้วแรก ปลดล็อกเฟรมการ์ด",
            description: "ผสานระบบ Booku POS ส่งบัตรคิวดิจิทัลและสลิปเซลฟี่เข้า LINE OA 100% ลดการใช้กระดาษความร้อนหน้าร้านกว่า 15,000 ใบ",
          },
          {
            tag: "2. STYLE",
            title: "DIY Counter & Upgrade Pack",
            subtitle: "แต่งแก้วสอง ปลดล็อกของตกแต่ง",
            description: "จัดตั้งเคาน์เตอร์ DIY กะทัดรัด 1.5-2 ตร.ม. แยกสัดส่วนจากบาร์ชง รองรับรอบละ 4 คน พร้อมการทำความสะอาดฆ่าเชื้อทุก 30 นาที",
          },
          {
            tag: "3. SHARE",
            title: "Social Stunt & Silicon Charm",
            subtitle: "แชร์หนวดชีส 45° ปลดล็อกตัวห้อยพวงกุญแจ",
            description: "ถ่ายภาพอวดหนวดชีสเขียวคู่กับเฟรมการ์ดลงโซเชียล ปลดล็อกรับตัวห้อยซิลิโคน Chibi Nosey เสริมแรงตามหลัก Set Completion",
          },
          {
            tag: "OPERATIONS",
            title: "Take-Home Fallback & Sourcing",
            subtitle: "แผนลดความแออัดและแต้มต่อต้นทุน",
            description: "แจก Take-Home DIY Kit ในซองกันน้ำทันทีเมื่อคิวเกิน 10 นาที พร้อมสั่งผลิตพลาสติก PP ผ่านซัพพลายเออร์ Nakiz ลดต้นทุนวัสดุลง 40%",
          },
        ],
      },
      {
        badge: "04 FINANCIAL ARCHITECTURE & MEASURABLE KPIS",
        title: "฿500K Budget Allocation, Break-Even at 7,576 Cups & 260% ROI",
        subtitle: "การวางแผนงบประมาณที่คุ้มค่า การรักษากำไรขั้นต้นหน้าร้าน 55% และการวัดผลลัพธ์ทางธุรกิจ",
        content: "ภายใต้งบประมาณจำกัด 500,000 บาท ทีมงานได้จัดสรรอย่างคุ้มค่า: ดิจิทัล & POS 24% (120,000บ.), ของพรีเมียม DIY 30% (150,000บ.), สื่อหน้าร้าน 16% (80,000บ.), Micro-Influencer UGC Loop 16% (80,000บ.), Performance Ads 12% (60,000บ.) และสำรองฉุกเฉิน 2% (10,000บ.)\n\nการตั้งราคาเมนูแคมเปญ 120 บาท ควบคุมต้นทุน COGS ที่ 45% (54 บาท: วัตถุดิบ 38บ. + พรีเมียม 16บ.) ส่งผลให้มีกำไรขั้นต้น 66 บาทต่อแก้ว (Store GP Margin 55%) จุดคุ้มทุนแคมเปญอยู่ที่ 7,576 แก้ว (สัปดาห์ที่ 3) และยอดขายเป้าหมาย 15,000 แก้วจะสร้างรายได้สะสม 1,800,000 บาท คิดเป็นผลตอบแทน ROI สูงถึง 260.0% พร้อมฐานสมาชิก LINE OA ใหม่กว่า 15,000 ราย",
        image: "/images/Project/NoseTea/20.png",
        imageCaption: "สไลด์ Financial & Measurable KPIs: โมเดลการเงิน จุดคุ้มทุน 7,576 แก้ว และผลตอบแทนการลงทุน 260%",
        type: "grid",
        items: [
          {
            tag: "BUDGET SPREAD",
            title: "฿500,000 Structured Allocation",
            subtitle: "จัดสรรงบ 6 หมวดเพื่อประสิทธิภาพสูงสุด",
            description: "กระจายงบสมดุลระหว่างระบบดิจิทัล (24%), ของพรีเมียม (30%), สื่อหน้าร้าน (16%), สื่อ UGC (16%), โฆษณา (12%), และสำรองฉุกเฉิน (2%)",
          },
          {
            tag: "GP PROTECTION",
            title: "55% Store Gross Profit Margin",
            subtitle: "ราคาขาย 120 บาท ควบคุม COGS 45%",
            description: "รักษา GP หน้าร้านที่ 55% (กำไร 66 บ./แก้ว) และปลอดภัยแม้ขายเดลิเวอรีแอปที่หัก GP 32% ยังคงมีกำไรขั้นต้นเหลือ 27.60 บ./แก้ว",
          },
          {
            tag: "BREAK-EVEN",
            title: "7,576 Cups in Week 3",
            subtitle: "จุดคุ้มทุนแคมเปญจากการขายจริง",
            description: "คำนวณจากงบ 500,000 บาท / กำไรขั้นต้นส่วนเพิ่ม 66 บาทต่อแก้ว คืนทุนได้ตั้งแต่สัปดาห์ที่ 3 ของการดำเนินงาน",
          },
          {
            tag: "CAMPAIGN ROI",
            title: "260.0% Financial Return",
            subtitle: "ยอดขายเป้าหมาย 15,000 แก้ว (1.8 ล้านบาท)",
            description: "สร้างผลตอบแทนสุทธิ 260% สมาชิก LINE OA ใหม่ +15,000 ราย อัตราซื้อซ้ำโต 25% และยอดวิว UGC รวมกว่า 2,000,000 วิว",
          },
        ],
      },
    ],
    gallery: [
      "/images/Project/NoseTea/Banner.jpg",
      "/images/Project/NoseTea/1.png",
      "/images/Project/NoseTea/2.png",
      "/images/Project/NoseTea/3.png",
      "/images/Project/NoseTea/4.png",
      "/images/Project/NoseTea/5.png",
      "/images/Project/NoseTea/6.png",
      "/images/Project/NoseTea/7.png",
      "/images/Project/NoseTea/8.png",
      "/images/Project/NoseTea/9.png",
      "/images/Project/NoseTea/10.png",
      "/images/Project/NoseTea/11.png",
      "/images/Project/NoseTea/12.png",
      "/images/Project/NoseTea/13.png",
      "/images/Project/NoseTea/14.png",
      "/images/Project/NoseTea/15.png",
      "/images/Project/NoseTea/16.png",
      "/images/Project/NoseTea/17.png",
      "/images/Project/NoseTea/18.png",
      "/images/Project/NoseTea/19.png",
      "/images/Project/NoseTea/20.png",
      "/images/Project/NoseTea/21.png",
      "/images/Project/NoseTea/22.png",
      "/images/Project/NoseTea/23.png",
      "/images/Project/NoseTea/24.png",
      "/images/Project/NoseTea/25.png",
      "/images/Project/NoseTea/26.png",
      "/images/Project/NoseTea/27.png",
      "/images/Project/NoseTea/28.png",
      "/images/Project/NoseTea/29.png",
      "/images/Project/NoseTea/30.png",
      "/images/Project/NoseTea/31.png",
    ],
  },
  {
    slug: "chao-dom",
